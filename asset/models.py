...
class Server_Assets(models.Model):
    ...
    # keyfile = FileField(upload_to = './upload/key/',blank=True,null=True,verbose_name='密钥文件')
...
class Zone_Assets(models.Model):
    ...
    class Meta:
        ...
        default_permissions = ()
        permissions = (
            ("add_zone_assets", "添加区域机房权限"),
            ("change_zone_assets", "更改区域机房权限"),
            ("delete_zone_assets", "删除区域机房权限"),
            ("read_zone_assets", "读取区域机房权限"),
        )
        verbose_name = '资产管理'
